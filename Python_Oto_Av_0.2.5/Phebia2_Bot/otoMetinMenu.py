...
def metinKesPasif():
    ...
    print(otoMetinLabel.get())
    print(otoMetinLabel1.get())    
    while l.get() == 1:
        try:
            metinBul(lastCoor,lastCoor1)
            gc.collect()
...
def pencereyiKapat(zatenKapali):
    ...
    kapat = pyBotOpenCV.locateCenterOnScreen(image="./Phebia2_Bot/img/cikis.PNG",matchvalue=0.91)
...
def biyologTeslimEt(zatenKapali):
    ...
    teslimEt = pyBotOpenCV.locateCenterOnScreen(image="./Phebia2_Bot/img/teslimEt.PNG",matchvalue=0.91)
...
def biyologPenceresiniAc(zatenKapali):
    ...
    biyologAc = pyBotOpenCV.locateCenterOnScreen(image="./Phebia2_Bot/img/biyolog.PNG",matchvalue=0.91)
    ...
    if l.get() == 1:
        ...
        if otoMetinLabel.get() == 1:
            ...
            if otoMetinButton4.get() == "Kıskançlık Metini":
                secilenMetin = "./Phebia2_Bot/img/KiskanclikMetini.PNG"
                dagilimy = 70
                stoneInfoArea = (200,10,500,100)
            elif otoMetinButton4.get() == "Gölge Metini":
                secilenMetin = "./Phebia2_Bot/img/GolgeMetini.PNG"
                dagilimy = 70
                stoneInfoArea = (200,10,500,100)
            elif otoMetinButton4.get() == "Dayanıklılık Metini":
                secilenMetin = "./Phebia2_Bot/img/DayaniklilikMetini.PNG"
                dagilimy = 70
                stoneInfoArea = (200,10,500,100)
            elif otoMetinButton4.get() == "Katil Metini":
                secilenMetin = "./Phebia2_Bot/img/KatilMetini.PNG"
                dagilimy = 70
                stoneInfoArea = (200,10,500,100)
        ...
        if otoMetinLabel1.get() == 1:
            ...
            if hwnd2 != 0:
                if metinValue.get() == "Kıskançlık Metini":
                    secilenMetin1 = "./Phebia2_Bot/img/KiskanclikMetini.PNG"
                    dagilimy1 = 70
                    stoneInfoArea1 = (200,10,500,100)
                elif metinValue.get() == "Gölge Metini":
                    secilenMetin1 = "./Phebia2_Bot/img/GolgeMetini.PNG"
                    dagilimy1 = 70
                    stoneInfoArea1 = (200,10,500,100)
                elif metinValue.get() == "Dayanıklılık Metini":
                    secilenMetin1 = "./Phebia2_Bot/img/DayaniklilikMetini.PNG"
                    dagilimy1 = 70
                    stoneInfoArea1 = (200,10,500,100)
                elif metinValue.get() == "Katil Metini":
                    secilenMetin1 = "./Phebia2_Bot/img/KatilMetini.PNG"
                    dagilimy1 = 70
                    stoneInfoArea1 = (200,10,500,100)
