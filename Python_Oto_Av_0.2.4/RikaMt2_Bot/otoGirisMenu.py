...
def hataAra(left, top):
    hata = pyBotOpenCV.locateCenterOnScreen("./RikaMt2_Bot/img/ok.PNG")
    if hata != None:
...
def oyundaMi():
    Info = pyBotOpenCV.matchTemplateImage(image="./RikaMt2_Bot/img/oyundaMi.PNG",matchvalue=0.91)
    if Info is None:
        del Info
        oyundaMi()
    else:
...
def otomatikGiris():
        if oG.get() == 1:
            ...
            while oG.get() == 1:
                try:
                    giris = pyBotOpenCV.locateCenterOnScreen("./RikaMt2_Bot/img/giris.PNG")
                    if giris != None:
                        ...
                        if hata != None:
                            ...
                            del hata
                        del hata
                    karakter = pyBotOpenCV.locateCenterOnScreen("./RikaMt2_Bot/img/karakter.PNG")
                    if karakter != None:
...
def yenidenBasla():
    try:
        if yB.get() == 1:
            ...
            while yB.get() == 1:
                try:
                    yenidenBasla = pyBotOpenCV.locateCenterOnScreen("./RikaMt2_Bot/img/yenidenBasla.PNG")
